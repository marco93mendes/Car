...
class ItemDetailActivity : AppCompatActivity() {
    ...
    private fun setupView() {
        ...
        binding.editCTA.setOnClickListener {
            val intent = FormActivity.newIntent(this, item)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                when (result) {
                    ...
                    is Result.Error -> {
                        Toast.makeText(this@ItemDetailActivity, getString(R.string.error_delete_item), Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
    ...
    private fun handleSuccessDelete() {
        Toast.makeText(this@ItemDetailActivity, getString(R.string.msg_item_deleted), Toast.LENGTH_LONG).show()
        finish()
    }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                when (result) {
                    ...
                    is Result.Error -> {
                        Toast.makeText(this@ItemDetailActivity, getString(R.string.error_fetch_details), Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
    ...
    private fun handleSuccessLoad() {
        ...
        binding.name.text = getString(R.string.label_model, car.name)
        binding.year.text = getString(R.string.label_year, car.year)
        binding.licence.text = getString(R.string.label_licence, car.licence)
